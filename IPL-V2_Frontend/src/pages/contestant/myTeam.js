...
function MyTeam() {
  ...
  const setPlaying11 = async () => {
    ...
    if (categoriesCount.wk >= 1 && categoriesCount.bowl + categoriesCount.all >= 5 && categoriesCount.bat >= 2 && categoriesCount.bowl >= 2 && categoriesCount.foreign <= 4 && contest.noplayers == 12) {
